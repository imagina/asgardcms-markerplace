...
use Modules\Marketplace\Transformers\LevelCriteriaTransformer;


class LevelCriteriaApiController extends BaseApiController
{
    /**
    ...
    public function __construct(LevelCriteriaRepository $entity)
    {
        parent::__construct();
    ...
    public function index(Request $request)
    {
        try {
            ...
            //Response
            $response = ["data" => LevelCriteriaTransformer::collection($dataEntity)];
    ...
    public function show($criteria, Request $request)
    {
        try {
            ...
            //Response
            $response = ["data" => new LevelCriteriaTransformer($dataEntity)];
    ...
    public function create(Request $request)
    {
        ...
        try {
            ...
            //Validate Request
            $this->validateRequestApi(new CreateLevelCriteriaRequest($data));
    ...
    public function update($criteria, Request $request)
    {
        ...
        try {
            ...
            //Validate Request
            $this->validateRequestApi(new UpdateLevelCriteriaRequest($data));
