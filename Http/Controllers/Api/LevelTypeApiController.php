...
use Modules\Marketplace\Transformers\LevelTypeTransformer;


class LevelTypeApiController extends BaseApiController
{
    /**
     * @var LevelRepository
     */
    ...
    public function __construct(LevelTypeRepository $entity)
    {
        parent::__construct();
    ...
    public function index(Request $request)
    {
        try {
            ...
            //Response
            $response = ["data" => LevelTypeTransformer::collection($dataEntity)];
    ...
    public function show($criteria, Request $request)
    {
        try {
            ...
            //Response
            $response = ["data" => new LevelTypeTransformer($dataEntity)];
    ...
    public function create(Request $request)
    {
        ...
        try {
            ...
            //Validate Request
            $this->validateRequestApi(new CreateLevelTypeRequest($data));
    ...
    public function update($criteria, Request $request)
    {
        ...
        try {
            ...
            //Validate Request
            $this->validateRequestApi(new UpdateLevelTypeRequest($data));
